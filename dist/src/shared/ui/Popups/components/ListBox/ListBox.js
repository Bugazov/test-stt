...
export function ListBox(props) {
    ...
    return (_jsxs(HStack, __assign({ gap: "4" }, { children: [label && _jsx("span", { children: "".concat(label, ">") }, void 0), _jsxs(HListBox, __assign({ disabled: readonly, as: "div", className: classNames(cls.ListBox, {}, [className, popupCls.popup]), value: value, onChange: onChange }, { children: [_jsx(HListBox.Button, __assign({ className: cls.trigger }, { children: _jsx(Button, __assign({ disabled: readonly }, { children: value !== null && value !== void 0 ? value : defaultValue }), void 0) }), void 0), _jsx(HListBox.Options, __assign({ className: classNames(cls.options, {}, optionsClasses) }, { children: items === null || items === void 0 ? void 0 : items.map(function (item) { return (_jsx(HListBox.Option, __assign({ value: item.value, disabled: item.disabled, as: Fragment }, { children: function (_a) {
                                var _b;
