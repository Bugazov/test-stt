...
export var Select = function (props) {
    ...
    var mods = {};
    return (_jsxs("div", __assign({ className: classNames(cls.Wrapper, {}, [className]) }, { children: [label && (_jsx("span", __assign({ className: cls.label }, { children: "".concat(label, ">") }), void 0)), _jsx("select", __assign({ disabled: readonly, className: cls.select, value: value, onChange: onChangeHandler }, { children: optionsList }), void 0)] }), void 0));
};
