...
export var CurrencySelect = memo(function (props) {
    ...
    return (_jsx(Select, { className: classNames('', {}, [className]), label: t('Укажите валюту'), options: options, onChange: onChangeHandler, value: value, readonly: readonly }, void 0));
});
